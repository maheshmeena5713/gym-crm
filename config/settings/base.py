...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.frontend.context_processors.subscription_context',
            ],
        },
    },
]
...
AUTHENTICATION_BACKENDS = [
    'apps.users.backends.GymPasswordBackend',
...
# WhatsApp (WATI)
WATI_API_URL = config('WATI_API_URL', default='')
...
OTP_DEFAULT_CODE = config('OTP_DEFAULT_CODE', default='123456')
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Gym AI SaaS API',
    'DESCRIPTION': 'AI-powered gym management platform. Multi-tenant SaaS for gym owners in India.',
    'VERSION': '1.0.0',
    ...
    'TAGS': [
        ...
        {'name': 'Membership Plans', 'description': 'Gym membership plans'},
    ],
}
